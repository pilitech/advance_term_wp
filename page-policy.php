...
<body>
  ...
  */
  ...
  <div class="main">
    <h1 class="title_main">PRIVACY POLICY</h1>
    <p class="title_sub">プライバシーポリシー</p>
    <!--全ページ共通タイトル部分　ここまで-->

    <div class="policy_main_content">
      <p class="policy_sentence">
        株式会社estra（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br>
        <br>
        <span class="policy_sentence_title">第1条（個人情報）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第2条（個人情報の収集方法）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第3条（個人情報を収集・利用する目的）</span><br>
        ...
        8.上記の利用目的に付随する目的<br>
        <br>
        <span class="policy_sentence_title">第4条（利用目的の変更）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第5条（個人情報の第三者提供）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第6条（個人情報の開示）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第7条（個人情報の訂正および削除）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第8条（個人情報の利用停止等）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第9条（プライバシーポリシーの変更）</span><br>
        ...
        <br>
        <span class="policy_sentence_title">第10条（お問い合わせ窓口）</span><br>
